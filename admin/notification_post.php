...
<?php
	if(isset($_POST['submit']))
	{
		...
		if(!empty($_POST['title']) && !empty($_POST['description']) && !empty($_POST['district']) && !empty($_POST['mandal']) && !empty($_POST['village']))
		{
			...
			$query=mysql_query("insert into notifications (title,description,send_by,send_to,date_post,mandal,village,district,allow) values('$title','$description','$name','$village','$date','$mandal','$village','$district','1')");
